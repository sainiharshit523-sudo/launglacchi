...
export const Route = createFileRoute("/admin")({
  head: () => ({
    meta: [
      { title: "Admin Portal | Laung Laachi Restaurant & Banquet Hall" },
      ...
      <header className="sticky top-0 z-50 border-b border-border/80 bg-background/95 backdrop-blur-md shadow-xs">
        <div className="mx-auto flex h-20 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center gap-4">
            <Link to="/" title="Go to website homepage">
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <Button
              ...
              size="sm"
              variant="outline"
              className="hidden md:inline-flex h-9 text-xs font-bold border-border hover:border-primary"
            >
              <Link to="/">
